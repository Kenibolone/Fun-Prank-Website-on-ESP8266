...
8. Open a browser and go to `192.168.4.1` to see the prank webpage in action!
...
- Make sure you have selected the correct board (e.g., **NodeMCU 1.0**) from the **Tools** menu.
